    ...
    <div className="max-w-[1344px] mx-auto flex flex-col items-center m-20">
      ...
      <Dialog.Root>
        ...
        <Dialog.Portal>
          ...
          <Dialog.Content className="fixed bg-[#2A2634] py-8 px-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg w-[480px] overflow-hidden shadow-lg shadow-black/25">
            ...
            <form className="mt-8 flex flex-col gap-4">
              ...
              <div className="flex gap-6">
                ...
                <div className="flex flex-col gap-2 flex-1">
                  <label htmlFor="hourStart" className="font-semibold"> Qual a hora do dia?</label>
